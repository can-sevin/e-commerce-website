...
<html lang="en">
  ...
  <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i> Siparişler</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-table"></i>Siparişler Listesi</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
        <div class="row">
          <div class="col-sm-6">
            <section class="panel">
            <a class="btn btn-info" href="<?=base_url()?>admin/uyeler/ekle">Sipariş Ekle</a>
              ...
              <table class="table table-striped">
                  ...
                  <?php
                    ...
                    <td><?=$rs->tarih?></td>
  									...
  									<td><?=$rs->adet?></td>
  									<td><?=$rs->tutar?> TL</td>
                    <td><a href="<?=base_url()?>siparisler/siparisdetay/<?=$rs->Id?>" class="btn btn-block btn-danger btn-xs">Detay<i class="fa fa-remove"></i></td>
              ...
              <hr>
  						<p class="cart-total right">
  							<strong>Sipariş Toplamı</strong>:<?=$toplam?>TL<br>
  						</p>
  						<hr/>
              <hr>
                  ...
                  <form method="post" action="<?=base_url()?>admin/siparisler/guncelle/<?=$siparisid?>">
                    ...
                    <br>
                    Açıklama:
                    <textarea class="form-control" name="mesaj" rows=5 cols="100"><?=$veri[0]->aciklama?></textarea><br>

                    <button type="submit" class="shopBtn" value="Güncelle">Güncelle</button>
                  </form>
              </p>
            </section>
          </div>
