                ...
                <div class="panel-body">
                    <form role="form" method="post" action="<?=base_url()?>admin/urunler/guncelle/<?=$veri[0]->id?>">
                        <div class="form-group">
                            ...
                            <input type="text" name="ad" value="<?=$veri[0]->ad?>" class="form-control" placeholder="Ürün Adı">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Afiyat</label>
                            <input type="text" name="afiyat" value="<?=$veri[0]->afiyat?>" class="form-control" placeholder="Afiyat">
                        </div>
                        <div class="form-group">
                            <label for="col-sm-2 control-label">Sfiyat</label>
                            <input type="text" name="sfiyat" value="<?=$veri[0]->sfiyat?>" class="form-control" placeholder="Sfiyat">
                        </div>
