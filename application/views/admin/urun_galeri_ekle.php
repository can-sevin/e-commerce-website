...
<html lang="en">
  ...
  <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-table"></i>Galeri Resim Ekleme</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-table"></i>Ürün Galeri Resim Ekleme</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
        ...
        <div class="col-lg-6">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="<?=base_url()?>admin/Urunler/galeri_kaydet/<?=$id?>" enctype="multipart/form-data">
                    ...
                    <?php foreach($veriler as $rs) { ?>
                      ...
                      <a href="<?=base_url()?>admin/urunler/galeri_sil/<?=$id?>/<?=$rs->Id?>"
                        onclick="return confirm('Kayıt silinsin mi?')" class="btn btn-warning">Sil</a>
                    <?php } ?>
                </div>
            </section>
        </div>
