...
<html lang="en">
  ...
  <section id="main-content">
          <section class="wrapper">
			  ...
			  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header">ANA SAYFA</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="<?=base_url()?>admin/home">Ana Sayfa</a></li>
					</ol>
				</div>
			</div>
            <div class="row">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table bootstrap-datatable countries">
								...
								<tbody>
									<tr>
										<td><img src="<?=base_url()?>assets/admin/img/Germany.png" style="height:18px; margin-top:-2px;"></td>
										<td>Germany</td>
										<td>2563</td>
										<td>1025</td>
										<td>
									...
									<tr>
										<td><img src="<?=base_url()?>assets/admin/img/India.png" style="height:18px; margin-top:-2px;"></td>
										<td>India</td>
										<td>3652</td>
										<td>2563</td>
										<td>
									...
									<tr>
										<td><img src="<?=base_url()?>assets/admin/img/Spain.png" style="height:18px; margin-top:-2px;"></td>
										<td>Spain</td>
										<td>562</td>
										<td>452</td>
										<td>
                    ...
                    <ul class="chats">
                      ...
                      <li class="by-other">
                        ...
                        <div class="avatar pull-right">
                          <img src="<?=base_url()?>assets/admin/img/user22.png" alt=""/>
                        </div>

                        <div class="chat-content">
                          <!-- In the chat meta, first include "time" then "name" -->
                          <div class="chat-meta">3 hours ago <span class="pull-right"><?=$this->session->admin_session["adsoy"]?></span></div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-4">
                                <span class="profile-ava pull-right">
                                        <img alt="" class="simple" src="<?=base_url()?>assets/admin/img/avatar1_small.jpg">
