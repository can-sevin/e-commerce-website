  ...
  <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-sm-6">
            <section class="panel">
            <a class="btn btn-success btn-lg" href="<?=base_url()?>admin/uyeler/ekle">Üye Ekle</a>
              ...
              <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td><?=$rs->sifre?></td>
                    <td><?=$rs->sehir?></td>
                    <td><a href="<?=base_url()?>admin/uyeler/duzenle/<?=$rs->id?>" class="btn btn-primary">Düzenle</a></td>
                    <td><a href="<?=base_url()?>admin/uyeler/sil/<?=$rs->id?>" onclick="return confirm('Kayıt silinsin mi?')" class="btn btn-danger" >Sil</a></td>
