	...
	<head>
               ...
               <li><a  class="<?=$anasayfa?>" href="<?=base_url()?>home">Anasayfa</a></li>
       				...
       				<div id="login-content">
         				<form>
           				<a href="<?=base_url()?>uye/hesabim">Hesabım</a>
 									<br><a href="<?=base_url()?>uye/sepetim">Sepetim</a>
      				...
      				<div id="login-content">
            			...
            			<input type="submit" id="submit" value="Giriş">
									...
									<br><a href="<?=base_url()?>home/uye/yeni_uye">Kayıt Ol!</a>
		...
		<section class="navbar main-menu">
		  <div class="navbar-inner main-menu">
            ...
            <ul><li><a href="<?=base_url()?>uye/profil_resim">Profil resmi</a></li></ul>
            <ul><li><a href="<?=base_url()?>uye/hesabim">Hesabım</a></li></ul>
            <ul><li><a href="<?=base_url()?>uye/siparisler">Siparişler</a></li></ul>
            <ul><li><a href="<?=base_url()?>uye/sepetim">Sepetim</a></li></ul>
            <ul><li><a href="<?=base_url()?>uye/yorumlar">Yorumlarım</a></li></ul>
            <ul><li><a href="<?=base_url()?>uye/urunlerim">Ürünlerim</a></li></ul>
            <ul><li><a href="<?=base_url()?>uye/favoriurunler">Favori Ürünlerim</a></li></ul>
		     	</nav>
		  </div>
		</section>
	</div>
