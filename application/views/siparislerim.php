  ...
  <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-sm-6">
            <section class="panel">
            <a class="btn btn-info" href="<?=base_url()?>admin/siparis/ekle">Sipariş Ekle</a>
                ...
                <tr>
                    ...
                    <td>
                      <?php if ($rs->siparisdurumu=="kargoda"){?>
                        <a href="<?=$rs->kargo?>" class="btn btn-primary">Kargo Takip</a>
                        <?php }?>
                      <?=$rs->siparisdurumu?></td>
                    <td><a href="<?=base_url()?>uye/siparisdetay/<?=$rs->Id?>" class="btn btn-primary">Detay</a></td>
                  </tr>
                </tbody>
                <?php } ?>
              </table>
